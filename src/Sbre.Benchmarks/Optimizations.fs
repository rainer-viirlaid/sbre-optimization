...
type MatchCountingCorrectness () =
    ...
    member this.ManualTesting() =
        Console.WriteLine("Twain")
        this.MatchCountTestingTwain()
        Console.WriteLine("Tammsaare")
        this.MatchCountTestingTammsaare()
        Console.WriteLine("EstWiki")
        this.MatchCountTestingEstWiki()
        Console.WriteLine("EngWiki")
        this.MatchCountTestingEngWiki()
        Console.WriteLine("DotNetRuntime")
    ...
    member this.MatchCountTestingEstWiki() =
        let pats = [|
            ...
            PatternsEstWiki.HELI_AJA_AZ      // 54998, sbre slow
