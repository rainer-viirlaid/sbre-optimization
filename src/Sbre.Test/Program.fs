...
// let tCount = tRegex.Count(fullInput)
// tRegex.TSetMatcher.StartSearchMode <- StartSearchOptimization.Original
// let tCount2 = tRegex.Count(fullInput)
// tRegex.TSetMatcher.StartSearchMode <- StartSearchOptimization.Weighted
// let tCount3 = tRegex.Count(fullInput)
// tRegex.TSetMatcher.CalculatePrefixSetWeights()
// let tCount4 = tRegex.Count(fullInput)
// tRegex.TSetMatcher.CalculatePrefixSetWeightsFromJson(frequenciesJsonText)
// let tCount5 = tRegex.Count(fullInput)
//
//
// let dbg1 =1
